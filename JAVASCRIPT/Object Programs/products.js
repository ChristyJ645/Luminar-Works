...
//prnt prdcts avail in range of price 50-100
...
////filtering names startng with b
var names_with_b=products.filter(item=>item.name[0]=='b')
console.log(names_with_b);



//// if mrp>55 add offer of 5%<50 offer:0%///hwwwwwww////hhhhwwww////////
